...
const Booking = ({ treatment, date, setTreatement, refetch }) => {
    let { _id, name, slots } = treatment;
        ...
        <div>
            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    ...
                    <h3 className="font-bold text-lg text-white text-center">Avaiable apoiment {name}!</h3>
